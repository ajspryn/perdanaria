...
use App\Http\Controllers\wahana\WahanaController;

// Main Page Route
Route::middleware(['auth:sanctum', 'verified'])->get('/', [Analytics::class, 'index'])->name('dashboard-analytics');
...
//wahana
Route::middleware(['auth:sanctum', 'verified'])->resource('wahana', WahanaController::class);
