...
@section('page-script')
    @vite(['resources/assets/js/app-access-roles.js', 'resources/assets/js/modal-add-role.js', 'resources/assets/js/tables-datatables-basic.js'])
@endsection
...
@section('content')
    ...
    <div class="row g-6">
        @foreach ($roles as $role)
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            <div class="role-heading">
                                ...
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#updateRoleModal{{ $role->name }}" class="role-edit-modal"><span>Edit Role</span></a>
                            </div>
            ...
            @include('_partials/_modals/modal-update-role')
        @endforeach
        <div class="col-xl-4 col-lg-6 col-md-6">
