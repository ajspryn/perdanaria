<!-- Add Role Modal -->
<div class="modal fade" id="updateRoleModal{{ $role->name }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="roles" class="row g-6">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" id="roleName" name="role_name" value="{{ $role->name }}" class="form-control" placeholder="Enter a role name" tabindex="-1" required />
                    </div>
                    <div class="col-12">
                                        ...
                                        <tr>
                                            ...
                                            @foreach ($chunk as $permission)
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        <div class="form-check mb-0">
                                                            <input class="form-check-input" name="permission[]" value="{{ $permission->id }}" {{ $role->hasPermissionTo($permission) ? 'checked' : '' }} type="checkbox" id="select{{ $permission->id }}" />
